    ...
    <div class="py-3">
        ...
        <div class=" ml-4 pr-3">
            <div class="flex justify-between items-center">
                <a href="{{ route('evento.participantes', ['id' => $event->id]) }}" class="btnreturn flex items-center space-x-2">
                    <x-icon_back/>
                    <h1 class="text-lg font-semibold">Planificación</h1>
                </a>
                @if($event->organizers->companies->id == auth()->user()->delegate->companies->id)
        ...
        <div class="container mx-auto p-4">
            <div class="bg-white shadow-lg p-0 flex">
                <div class="w-xs">
                    <img src="{{ asset($event->banner) }}" alt="{{$event->name}}" class="w-full object-cover">
                </div>
                <div class="w-1/2 p-4 relative">
                    ...
                    <div class="flex items-center mt-4">
                        <div class="logo-empre-container flex justify-center items-center">
                            <img src="{{asset($event->organizers->companies->logo)}}" alt="Logo" class="rounded-full">
                        </div>
